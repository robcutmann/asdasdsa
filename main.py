...
if __name__ == "__main__":
    ...
    for private_key in keys_list:
        ...
        # 1) покупаем STG
        # USDC_amount = 0.01
        USDC_amount = random.uniform(125.2497, 130.2)  # покупаем 131-140 монет на 61$ макс по курсу, на момент написания кода
        swap_out_str = 'USDC'
        swap_in_str = 'STG'
        ...
        STG_amount = STG_balance - round(random.uniform(100.1, 133.01), 4)
        if STG_amount < 27:
